                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: _model.txtModeloController,
                              ...
                              validator: _model.txtModeloControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              validator: _model.txtyearControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: _model.txtplacaController,
                              ...
                              validator: _model.txtplacaControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: _model.txturlimagenController,
                              focusNode: _model.txturlimagenFocusNode,
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                hintText: FFLocalizations.of(context).getText(
                                  'ge48fvmp' /* Ingrese url de la imagen */,
                                ),
                                hintStyle:
                                    FlutterFlowTheme.of(context).labelMedium,
                                enabledBorder: OutlineInputBorder(
                              ...
                              validator: _model.txturlimagenControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ],
                          ...
                          onPressed: () async {
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('Creacion de Vehiculo '),
                                  content: const Text(
