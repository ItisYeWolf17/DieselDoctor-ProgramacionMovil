...
import 'vechicles_model.dart';
export 'vechicles_model.dart';

class VechiclesWidget extends StatefulWidget {
  const VechiclesWidget({
    super.key,
  ...
  @override
  _VechiclesWidgetState createState() => _VechiclesWidgetState();
}

class _VechiclesWidgetState extends State<VechiclesWidget> {
  late VechiclesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VechiclesModel());
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(15.0, 15.0,
                                                          15.0, 15.0),
                                                  child: Text(
                                                    '${listViewVehiclesRecord.modelo} - ${listViewVehiclesRecord.year}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                        .override(
